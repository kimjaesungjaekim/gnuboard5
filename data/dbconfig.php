...
define('G5_MYSQL_PASSWORD', 'inno');
define('G5_MYSQL_DB', 'huki');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '6b593cbd3165a8cec2e1488f879ec7d9'); // 토큰 암호화에 사용할 키
...
// new 테이블
$g5['campaign_table'] = 'campaign'; // 캠페인 테이블
$g5['penalty_table'] = 'penalty';
$g5['penalty_history_table'] = 'penalty_history';
$g5['membership_table'] = 'membership';
$g5['media_table'] = 'media';
$g5['point_table'] = 'point';
$g5['point_history_table'] = 'point_history';
$g5['defrayment_table'] = 'defrayment';
$g5['delivery_table'] = 'delivery';
$g5['attendance_table'] = 'attendance';
